export const SITE = {
  ...
  loginHref: "/acceso-plataformas-big-ban-university",
};
...
export const HERO = {
  ...
  subtitle:
    "Más de 40 programas universitarios listos para empezar hoy. Pago en cuotas, sin intereses. Resultados que transforman carreras.",
  ctaPrimary: {
    label: "Ver programas y precios",
...
export const WHY_BIG_BAN_UNIVERSITY = [
  {
    icon: "🎓",
    title: "Título oficial incluido",
    desc:
      "Recibes un título reconocido por el Ministerio de Educación. Válido en toda Europa.",
  },
  {
    icon: "⚡",
    title: "Empieza hoy mismo",
    desc:
      "Acceso inmediato a todos los contenidos tras completar tu matrícula online.",
  },
  {
    icon: "💳",
    title: "Pago en cuotas sin intereses",
    desc:
      "Financia tu formación desde 49€/mes. Sin permanencia, cancela cuando quieras.",
  },
  {
    icon: "📱",
    title: "Estudia desde cualquier lugar",
    desc:
      "Plataforma 100% online adaptada a móvil, tablet y ordenador. Sin horarios fijos.",
  },
  {
    icon: "🏆",
    title: "Garantía de satisfacción",
    desc:
      "Si en los primeros 15 días no estás satisfecho, te devolvemos el dinero.",
  },
  {
    icon: "💼",
    title: "Bolsa de empleo incluida",
    desc:
      "Acceso a nuestra red de +500 empresas colaboradoras para prácticas y empleo.",
  },
];
...
export const TESTIMONIALS = [
  {
    name: "María García",
    program: "Grado en Psicología",
    text:
      "En 4 años conseguí mi título oficial estudiando desde casa.",
    avatar: "MG",
  },
  {
    name: "Carlos Ruiz",
    program: "Máster en Inteligencia Artificial",
    text:
      "Conseguí un aumento de sueldo del 40% al terminar el máster.",
    avatar: "CR",
  },
  {
    name: "Ana Martínez",
    program: "FP en Desarrollo Web",
    text:
      "En menos de un año ya tenía trabajo como desarrolladora.",
    avatar: "AM",
  },
];
...
export const FOOTER_LINKS = {
  ...
  Formación: [
    {
      label: "Grados oficiales",
      href: "/grados",
    },
    {
      label: "Másteres oficiales",
      href: "/masteres",
    },
    {
