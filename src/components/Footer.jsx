      ...
      <div style={styles.container}>
        <div style={styles.top}>
          <div style={styles.brand}>
            ...
            <div style={styles.contact}>
              <a href={SITE.phoneHref} style={styles.contactLink}>📞 {SITE.phone}</a>
              <a href={SITE.contactHref} style={styles.contactLink}>✉️ Contacto</a>
            </div>
          </div>
          ...
          {Object.entries(FOOTER_LINKS).map(([group, links]) => (
            <div key={group} style={styles.linkGroup}>
              ...
              <ul style={styles.linkList}>
                {links.map((l) => (
                  <li key={l.label}>
                    <a href={l.href} style={styles.link}>{l.label}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div style={styles.bottom}>
          ...
          <div style={styles.socialLinks}>
            ...
            <a href="#" style={styles.socialBtn}>ig</a>
            <a href="#" style={styles.socialBtn}>yt</a>
          </div>
        </div>
      </div>
    </footer>
...
const styles = {
  ...
  logoIcon: {
    width: "36px",
    height: "36px",
    background: "linear-gradient(135deg, #0a3d8f 0%, #e8431a 100%)",
    borderRadius: "8px",
    display: "flex",
    alignItems: "center",
